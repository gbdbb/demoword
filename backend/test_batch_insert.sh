...
API_BASE_URL="http://localhost:8080/api/reports"
...
-d '{
  "report": {
    "id": "R001",
    "generated_at": "2024-12-18 12:00:00",
    "status": "PENDING",
    "ai_judgment": "重复测试",
    "risk_level": "HIGH"
  },
